...
This document describes how security reports for the `file-manager` repository
...
[GitHub Security Advisory](https://github.com/bitty-terminal/file-manager/security/advisories/new).
...
The plugin requests only `terminal.semantic-read` (read-only cwd/title
observation) and contains no credentials, no install-time execution, and no
ambient OS authority. Privacy-relevant behavior is described in
[README.md](README.md); any deviation is a security-relevant defect.
