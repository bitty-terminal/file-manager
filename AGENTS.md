# Bitty File Manager repository guidance

## Repository and authority

- This is the independent `file-manager` repository. Its canonical remote is
  <https://github.com/bitty-terminal/file-manager>.
...
- Version pins live in exactly one place per pin: `package.json` + `bun.lock`
  for installed dev dependencies; the justfile runs the locked binaries via
