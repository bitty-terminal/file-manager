...
lua:
    bunx --bun luaparse@{{luaparse_pin}} --quiet --file lua/file-manager/init.lua
    bunx --bun luaparse@{{luaparse_pin}} --quiet --file lua/file-manager/scope.lua
    bunx --bun luaparse@{{luaparse_pin}} --quiet --file lua/file-manager/listing.lua
    bunx --bun luaparse@{{luaparse_pin}} --quiet --file lua/file-manager/scene.lua
