/**
 * LuaLS conformance check for the file-manager plugin sources.
 *
 ...
 *
 * - positive: `lua/file-manager/**` must diagnose cleanly, including the
 *   `require("file-manager.*")` module tree.
...
function main() {
  ...
  const temp = mkdtempSync(join(tmpdir(), "file-manager-luals-"));
  const problems = [];
  try {
